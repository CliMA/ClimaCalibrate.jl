...
To iterate through an `EKP.ObservationSeries`, you must provide a minibatcher. This package provides two helper functions to facilitate the creation of simple batches:
